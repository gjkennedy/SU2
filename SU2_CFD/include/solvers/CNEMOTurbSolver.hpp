 ...
 * \author A. Bueno.
 */
class CNEMOTurbSolver : public CScalarSolver<CNEMOTurbVariable> {
protected:
...
public:
   ...
   */
  CNEMOTurbSolver(CGeometry* geometry, CConfig *config, bool conservative);
