/*!
 * \file CNEMOTurbSSTSolver.cpp
 * \brief Main subrotuines of CNEMOTurbSSTSolver class
...
CNEMOTurbSSTSolver::CNEMOTurbSSTSolver(void) : CNEMOTurbSolver(true) { }

CNEMOTurbSSTSolver::CNEMOTurbSSTSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh)
    : CNEMOTurbSolver(geometry, config, true) {
  ...
  nodes = new CNEMOTurbSSTVariable(kine_Inf, omega_Inf, muT_Inf, nPoint, nDim, nVar, constants, config);
...
void CNEMOTurbSSTSolver::Preprocessing(CGeometry *geometry, CSolver **solver_container, CConfig *config,
...
void CNEMOTurbSSTSolver::Postprocessing(CGeometry *geometry, CSolver **solver_container,
...
void CNEMOTurbSSTSolver::Viscous_Residual(unsigned long iEdge, CGeometry* geometry, CSolver** solver_container,
...
void CNEMOTurbSSTSolver::Source_Residual(CGeometry *geometry, CSolver **solver_container,
...
void CNEMOTurbSSTSolver::Source_Template(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics,
                                     CConfig *config, unsigned short iMesh) {
}

void CNEMOTurbSSTSolver::BC_HeatFlux_Wall(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
...
void CNEMOTurbSSTSolver::SetTurbVars_WF(CGeometry *geometry, CSolver **solver_container,
...
void CNEMOTurbSSTSolver::BC_Far_Field(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                                  CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CNEMOTurbSSTSolver::BC_Inlet(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                              CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CNEMOTurbSSTSolver::BC_Outlet(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                               CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CNEMOTurbSSTSolver::BC_Inlet_MixingPlane(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                                          CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CNEMOTurbSSTSolver::BC_Inlet_Turbo(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics,
                                    CNumerics *visc_numerics, CConfig *config, unsigned short val_marker) {
...
void CNEMOTurbSSTSolver::SetInletAtVertex(const su2double *val_inlet,
...
su2double CNEMOTurbSSTSolver::GetInletAtVertex(su2double *val_inlet,
...
void CNEMOTurbSSTSolver::SetUniformInlet(const CConfig* config, unsigned short iMarker) {
