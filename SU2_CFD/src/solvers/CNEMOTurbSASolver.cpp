...
CNEMOTurbSASolver::CNEMOTurbSASolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel)
             : CNEMOTurbSolver(geometry, config,false) {
...
void CNEMOTurbSASolver::Viscous_Residual(unsigned long iEdge, CGeometry* geometry, CSolver** solver_container,
...
void CNEMOTurbSASolver::SetTurbVars_WF(CGeometry *geometry, CSolver **solver_container,
...
void CNEMOTurbSASolver::ComputeUnderRelaxationFactor(const CConfig *config) {
